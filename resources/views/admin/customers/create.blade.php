                                ...
                                <form enctype="multipart/form-data" method="POST"
                                    ...
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <div class="input__group mb-25">
                                            ...
                                            <input type="text" name="street_address" value="{{ old('street_address') }}" placeholder="Enter Street Address">
                                        </div>

                                        <div class="input__group mb-25">
                                            <label>Zipcode</label>
                                            <input type="text" name="zipcode" value="{{ old('zipcode') }}" placeholder="Enter Zipcode">
                                        </div>
