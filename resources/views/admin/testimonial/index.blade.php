            ...
            <div class="col-md-12">
                <div class="customers__area bg-style mb-30">
                    ...
                    <div class="item-title">
                        <div class="col-xs-6">
                            <a href="{{ route('admin.testimonial.create') }}" class="btn btn-md btn-info">Add Testimonial</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($testimonial as $data)
                                        <tr role="row" class="odd">
                                            ...
                                            <td><img src="{{ asset('front/assets/images/' . $data->image) }}" alt="image" </td>
                                            ...
                                            <td>
                                                ...
                                                <div class="action__buttons">
                                                    ...
                                                    <a href="#" class="btn-action">
                                                        <form action="{{ route('admin.testimonial.delete', $data->id) }}"
