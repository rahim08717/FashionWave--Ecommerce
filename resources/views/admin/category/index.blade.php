            ...
            <div class="col-md-12">
                <div class="customers__area bg-style mb-30">
                    ...
                    <div class="item-title">
                        <div class="col-xs-6">
                            <a href="{{ route('admin.category.create') }}" class="btn btn-md btn-info">Add category</a>
                        </div>
                    </div>
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="ContactUsTable" rowspan="1"
                                            ...
                                            style="width: 224px;">Slug</th>
                                        <th class="sorting" tabindex="0" aria-controls="ContactUsTable" rowspan="1"
                                            colspan="1" aria-label="Email: activate to sort column ascending"
                                            style="width: 224px;">Meta Title</th>
                                        <th class="sorting" tabindex="0" aria-controls="ContactUsTable" rowspan="1"
                                            colspan="1" aria-label="Email: activate to sort column ascending"
                                            style="width: 224px;">Meta Keyword</th>
                                        <th class="sorting" tabindex="0" aria-controls="ContactUsTable" rowspan="1"
                                            colspan="1" aria-label="Email: activate to sort column ascending"
                                            style="width: 224px;">Meta Description</th>
                                        <th class="sorting" tabindex="0" aria-controls="ContactUsTable" rowspan="1"
                                            colspan="1" aria-label="Email: activate to sort column ascending"
                                            style="width: 224px;">Description</th>
                                        <th class="sorting" tabindex="0" aria-controls="ContactUsTable" rowspan="1"
                                            colspan="1" aria-label="Contact Number: activate to sort column ascending"
                                            style="width: 185px;">Icon</th>
                                ...
                                <tbody>
                                    @foreach ($category as $data)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="sorting_1">{{ $data->en_category_name }} ({{ $data->product_count ?? "0" }})</td>
                                            ...
                                            <td><img src="{{ asset('front/assets/images/' . $data->icon) }}"
                                                    alt="image" </td>
