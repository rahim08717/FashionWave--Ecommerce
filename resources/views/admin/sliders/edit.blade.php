                                ...
                                <form enctype="multipart/form-data" method="POST"
                                    ...
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <div class="input__group mb-25">
                                            ...
                                            <textarea name="description" placeholder="Enter Description">{{ $slider->description }}</textarea>
                                        </div>
                                        ...
                                        <div class="input__group mb-25">
                                            ...
                                            <img src="{{ asset('front/assets/images/slider/' . $slider->image) }}"
                                                class="admin_image" id="previewImage"
                                                style="max-width:180px; margin-top:10px;display: {{ $slider->image ? 'block' : 'none' }}; ">
                                        </div>
